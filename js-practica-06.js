...
let completed = localStorage.getItem("js-challenge-06") === "completed";
...
answers.forEach(function (answer) {
    answer.addEventListener("click", function () {
        ...
        if (answer.classList.contains("correct")) {
            completed = true;
            localStorage.setItem("js-challenge-06", "completed");

            feedback.textContent = "🎉 ¡Correcto! function declara bloques de código reutilizables.";
            feedback.className = "correct-feedback";
