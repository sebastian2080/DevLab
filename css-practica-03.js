...
let completed = localStorage.getItem("css-challenge-03") === "completed";
...
answers.forEach(function (answer) {
    answer.addEventListener("click", function () {
        ...
        if (answer.classList.contains("correct")) {
            completed = true;
            localStorage.setItem("css-challenge-03", "completed");

            feedback.textContent = "🎉 ¡Correcto! border-radius permite redondear los bordes.";
            feedback.className = "correct-feedback";
