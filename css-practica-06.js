...
let completed = localStorage.getItem("css-challenge-06") === "completed";
...
answers.forEach(function (answer) {
    answer.addEventListener("click", function () {
        ...
        if (answer.classList.contains("correct")) {
            completed = true;
            localStorage.setItem("css-challenge-06", "completed");

            feedback.textContent = "🎉 ¡Correcto! justify-content alinea los elementos en el eje principal (por defecto horizontal).";
            feedback.className = "correct-feedback";
