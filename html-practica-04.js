...
let completed = localStorage.getItem("html-challenge-04") === "completed";
...
answers.forEach(function (answer) {
    answer.addEventListener("click", function () {
        ...
        if (answer.classList.contains("correct")) {
            completed = true;
            localStorage.setItem("html-challenge-04", "completed");

            feedback.textContent = "🎉 ¡Correcto! <ul> se utiliza para listas no ordenadas.";
            feedback.className = "correct-feedback";
