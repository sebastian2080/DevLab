...
let completed = localStorage.getItem("js-challenge-04") === "completed";
...
answers.forEach(function (answer) {
    answer.addEventListener("click", function () {
        ...
        if (answer.classList.contains("correct")) {
            completed = true;
            localStorage.setItem("js-challenge-04", "completed");

            feedback.textContent = "🎉 ¡Correcto! === evalúa igualdad estricta sin conversión automática de tipos.";
            feedback.className = "correct-feedback";
