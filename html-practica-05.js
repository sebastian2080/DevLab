...
let completed = localStorage.getItem("html-challenge-05") === "completed";
...
answers.forEach(function (answer) {
    answer.addEventListener("click", function () {
        ...
        if (answer.classList.contains("correct")) {
            completed = true;
            localStorage.setItem("html-challenge-05", "completed");

            feedback.textContent = "🎉 ¡Correcto! El atributo src (source) indica la ruta de la imagen.";
            feedback.className = "correct-feedback";
