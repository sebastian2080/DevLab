...
let completed = localStorage.getItem("js-challenge-05") === "completed";
...
answers.forEach(function (answer) {
    answer.addEventListener("click", function () {
        ...
        if (answer.classList.contains("correct")) {
            completed = true;
            localStorage.setItem("js-challenge-05", "completed");

            feedback.textContent = "🎉 ¡Correcto! textContent define el contenido textual del nodo.";
            feedback.className = "correct-feedback";
